...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="课题分类" prop="ketifenlei">
            <el-select v-model="ruleForm.ketifenlei" placeholder="请选择课题分类"  >
              <el-option
          ...
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="课题状态" prop="ketizhuangtai">
            <el-select v-model="ruleForm.ketizhuangtai" placeholder="请选择课题状态"  >
              <el-option
          ...
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="开题日期" prop="kaitiriqi">
              <el-date-picker
				  :disabled=" false  ||ro.kaitiriqi"
          ...
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="电话号码" prop="dianhuahaoma">
            <el-input  v-model="ruleForm.dianhuahaoma" 
                placeholder="电话号码" clearable :readonly=" false  ||ro.dianhuahaoma"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="课题要求" prop="ketiyaoqiu">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="课题要求"
          ...
          <el-form-item :style='{"width":"auto","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="课题内容" prop="ketineirong">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/ketifenlei/ketifenlei', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.ketifenleiOptions = res.data.data;
          }
        });
        this.$http.get('option/yuanxi/yuanxi', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.yuanxiOptions = res.data.data;
          }
        });
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`ketixinxi/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post(`ketixinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
