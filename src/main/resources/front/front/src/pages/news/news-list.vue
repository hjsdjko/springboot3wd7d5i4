...
<div>
	<div :style='{"padding":"20px 0","margin":"0px auto","borderColor":"#1d8001","borderRadius":"0px","background":"none","borderWidth":"0 0 2px","width":"86%","borderStyle":"solid"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'>'" :style='{"fontSize":"14px","lineHeight":"1","justifyContent":"flex-end","display":"flex"}'>
			<el-breadcrumb-item class="item1"><a href="/index/home">首页</a></el-breadcrumb-item>
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index"><a href="/index/home">{{item.name}}</a></el-breadcrumb-item>
		</el-breadcrumb>
	</div>
	...
	<div class="news-preview-pv" :style='{"minHeight":"100vh","width":"100%","margin":"0px auto","position":"relative","background":"#fff"}'>
		...
		<div class="category" :style='{"padding":"30px 0 20px","margin":"60px 0 0 7%","borderColor":"#ddd","flexWrap":"wrap","background":"#fff","borderWidth":"0px 0","display":"flex","width":"250px","borderStyle":"solid","float":"left","justifyContent":"flex-start","height":"auto"}'>
		  ...
		  <div v-for="(item,index) in categoryList" @click="categoryClick(index+1)" :key="index" class="item" :class="categoryIndex == index+1 ? 'active' : ''">{{item.typename}}</div>
				...
				<div v-if="newsList.length" :style='{"minHeight":"1080px","padding":"0","margin":"20px 7% 0 0","background":"#fff","width":"calc(86% - 310px)","float":"right","height":"auto"}' class="list8 index-pv1">
		  <div :style='{"width":"100%","flexWrap":"wrap","display":"flex","height":"auto"}'>
		    <div :style='{"cursor":"pointer","width":"100%","margin":"0 0 20px","position":"relative","background":"#1d800110","height":"auto"}' @click="toNewsDetail(newsList[0])">
		      <img :style='{"width":"100%","objectFit":"cover","display":"none","height":"auto"}' :src="baseUrl + newsList[0].picture">
		      <div :style='{"padding":"10px 20px","left":"0","bottom":"0","background":"rgba(0,0,0,.0)","width":"100%","position":"relative","zIndex":"9"}'>
		        <div :style='{"overflow":"hidden","whiteSpace":"nowrap","color":"#000","width":"100%","lineHeight":"32px","fontSize":"16px","textOverflow":"ellipsis"}'>{{newsList[0].title}}</div>
		        <div :style='{"lineHeight":"24px","fontSize":"14px","overflow":"hidden","color":"#666","textIndent":"2em","height":"48px"}'>{{newsList[0].introduction}}</div>
		        <div :style='{"padding":"0 10px","lineHeight":"1.5","fontSize":"14px","color":"#999","textAlign":"right"}'>{{newsList[0].addtime}}</div>
		      </div>
		    </div>
		    <div v-if="newsList.length > 1" :style='{"width":"100%","padding":"0 0 0 20px","height":"auto"}'>
			  <template v-for="item,index in newsList">
				  <div v-if="index > 0 && index < 5" :style='{"cursor":"pointer","padding":"5px 0","borderColor":"#eee","alignItems":"center","borderWidth":"0 0 1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"center","height":"100px"}' @click="toNewsDetail(item)">
					<div :style='{"border":"0px solid #efefef","padding":"10px 0","margin":"0 20px 0 0","alignItems":"center","flexDirection":"column","display":"flex","width":"80px","justifyContent":"center","height":"100%"}'>
					  <div :style='{"color":"#666","lineHeight":"1.5","fontSize":"24px"}'>{{item.addtime.split(" ")[0].split("-")[2]}}</div>
					  <div :style='{"color":"#999","lineHeight":"1.5","fontSize":"16px"}'>{{item.addtime.split(" ")[0].split("-")[0] + '-' + item.addtime.split(" ")[0].split("-")[1]}}</div>
					</div>
		...
		<!-- 热门信息 -->
		<div class="hot" :style='{"width":"250px","padding":"0","margin":"0px 0 0 7%","float":"left","background":"#fff","height":"auto"}'>
		  <div :style='{"padding":"0 20px","borderColor":"#ddd","color":"#fff","borderRadius":"30px","textAlign":"center","background":"#28890b","borderWidth":"0 0 1px","width":"100%","lineHeight":"40px","fontSize":"18px","borderStyle":"solid"}'>推荐信息</div>
		  <div :style='{"padding":"0 10px","margin":"20px 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		    <div v-for="item in hotList" :key="item.id" :style='{"cursor":"pointer","width":"100%","padding":"0","margin":"0 0 20px","background":"#fff","height":"auto"}' @click="toNewsDetail(item)">
		      <img :style='{"width":"100%","objectFit":"cover","display":"block","clipPath":"polygon(0% 0%, 95% 0, 100% 50%, 95% 100%, 0% 100%)","height":"100px"}' :src="baseUrl + item.picture" alt="">
