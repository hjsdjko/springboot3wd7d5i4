<template>
	<div class="addEdit-block" :style='{"minHeight":"calc(100vh - 200px)","padding":"20px 0 30px","margin":"0 auto","color":"#666","background":"none","width":"calc(100% - 60px)","fontSize":"16px","height":"100%"}'>
		...
		>
			<template >
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'" label="选题编号" prop="xuantibianhao">
					<el-input v-model="ruleForm.xuantibianhao" placeholder="选题编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.xuantibianhao" label="选题编号" prop="xuantibianhao">
					<el-input v-model="ruleForm.xuantibianhao" placeholder="选题编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="选题时间" prop="xuantishijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.xuantishijian" 
						type="date"
						:readonly="ro.xuantishijian"
						placeholder="选题时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.xuantishijian" label="选题时间" prop="xuantishijian">
					<el-input v-model="ruleForm.xuantishijian" placeholder="选题时间" readonly></el-input>
				</el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.xuantishijian = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='xuantibianhao'){
							this.ruleForm.xuantibianhao = obj[o];
							this.ro.xuantibianhao = true;
							continue;
						}
						if(o=='ketimingcheng'){
    ...
    // 提交
    onSubmit() {
		if(this.ruleForm.xuantibianhao) {
			this.ruleForm.xuantibianhao = String(this.ruleForm.xuantibianhao)
		}
