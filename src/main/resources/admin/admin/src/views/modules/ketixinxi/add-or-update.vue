	...
	<div class="addEdit-block" :style='{"minHeight":"calc(100vh - 200px)","padding":"20px 0 30px","margin":"0 auto","color":"#666","background":"none","width":"calc(100% - 60px)","fontSize":"16px","height":"100%"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="课题分类" prop="ketifenlei">
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="院系" prop="yuanxi">
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="专业" prop="zhuanye">
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="课题状态" prop="ketizhuangtai">
					<el-select :disabled="ro.ketizhuangtai" v-model="ruleForm.ketizhuangtai" placeholder="请选择课题状态" >
						<el-option
							v-for="(item,index) in ketizhuangtaiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-else class="input" label="课题状态" prop="ketizhuangtai">
					<el-input v-model="ruleForm.ketizhuangtai"
						placeholder="课题状态" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="开题日期" prop="kaitiriqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.kaitiriqi" 
						type="date"
						:readonly="ro.kaitiriqi"
						placeholder="开题日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.kaitiriqi" label="开题日期" prop="kaitiriqi">
					<el-input v-model="ruleForm.kaitiriqi" placeholder="开题日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="发布时间" prop="fabushijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.fabushijian" label="发布时间" prop="fabushijian">
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="课题要求" prop="ketiyaoqiu">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="课题要求"
					  v-model="ruleForm.ketiyaoqiu" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.ketiyaoqiu" label="课题要求" prop="ketiyaoqiu">
					<span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.ketiyaoqiu}}</span>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-if="type!='info'"  label="课题内容" prop="ketineirong">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.ketineirong" label="课题内容" prop="ketineirong">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.ketineirong"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='ketizhuangtai'){
							this.ruleForm.ketizhuangtai = obj[o];
							this.ro.ketizhuangtai = true;
							continue;
						}
						if(o=='ketiyaoqiu'){
							this.ruleForm.ketiyaoqiu = obj[o];
							this.ro.ketiyaoqiu = true;
							continue;
						}
						if(o=='ketineirong'){
						...
						if(o=='kaitiriqi'){
							this.ruleForm.kaitiriqi = obj[o];
							this.ro.kaitiriqi = true;
							continue;
						}
						if(o=='fabushijian'){
				...
				this.ruleForm.ketizhuangtai='可选'
            ...
            this.ketizhuangtaiOptions = "已选,可选".split(',')
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.ketineirong = this.ruleForm.ketineirong.replace(reg,'../../../springboot3wd7d5i4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
