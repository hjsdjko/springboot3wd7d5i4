  ...
  <div>
    <div class="container" :style='{"minHeight":"100vh","alignItems":"flex-start","background":"url(http://codegen.caihongy.cn/20230831/206c5946d0df4398889fb00c865fccd6.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
      <el-form :style='{"border":"0px solid #f6f6f6","minHeight":"1000px","padding":"0px 20px 20px","boxShadow":"0 0px 0px rgba(0, 0, 0, .2)","margin":"0 auto","borderRadius":"0px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230811/c518cf0ec8c5434facdea340da558cd1.png) no-repeat center 240px,url(http://codegen.caihongy.cn/20230811/35998be3b95844a68cab0b7410497ea1.png) no-repeat center top / 100% 100%","width":"40%","fontSize":"16px","position":"relative","height":"auto"}'>
        <div v-if="true" :style='{"padding":"0px","margin":"180px auto 230px","borderColor":"#ddd","color":"#333","background":"none","borderWidth":"0px","display":"inline-block","width":"80%","lineHeight":"auto","fontSize":"26px","borderStyle":"solid","fontWeight":"600"}' class="title-container">基于Web的毕业设计选题系统的设计与实现登录</div>
